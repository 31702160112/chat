...
public class login extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btn;
    private TextView tv,btn_zc,tv_tc;
...
//                    SHOWData("用户名："+dl.getName()+"\n账号密码："+dl.getUser()+"\n登录状态："+dl.getStatus());
            ...
            break;
            case R.id.btn_zc:
               Intent it=new Intent(this,registered.class);
               startActivity(it);
                break;
            case R.id.tv_tc:
                Toast.makeText(login.this, "各位亲，这还没开发哦", Toast.LENGTH_SHORT).show();
                break;
        }
    }
