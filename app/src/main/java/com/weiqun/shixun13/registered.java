        ...
        switch (v.getId()){
            case R.id.btn_zc:
                ...
                if(TextUtils.isEmpty(name1)){
                    Toast.makeText(registered.this, "请输入姓名", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                UtilsOk.httpPostUtils_Reg_zc("http://123.207.85.214/chat/register.php", name1, user1, psw1, new Callback() {
                    ...
                    public void onFailure(Call call, IOException e) {
                        Looper.prepare();
                        Toast.makeText(registered.this, "数据请求失败，请重试", Toast.LENGTH_SHORT).show();
                        Looper.loop();
                    }
                ...
                break;
                case R.id.btn_tc:
                    Toast.makeText(registered.this, "你点击了退出按钮", Toast.LENGTH_SHORT).show();
